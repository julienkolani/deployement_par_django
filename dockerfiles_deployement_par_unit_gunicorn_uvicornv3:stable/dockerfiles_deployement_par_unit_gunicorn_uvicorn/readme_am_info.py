...
if __name__ == "__main__":
    ...
    print("""
        ...
        Assurez-vous aussi d'avoir configurer le settings.py pour la collecte des fichiers statics :
            
        # Configuration des fichiers statiques
        STATIC_URL = '/static/'
        STATICFILES_DIRS = [
            os.path.join(BASE_DIR, 'static'),  # Répertoire de fichiers statiques partagés
        ]

        STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles/static')
          
        Les fichiers statics étant stocker dans /staticfiles/static.
